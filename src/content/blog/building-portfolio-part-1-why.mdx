...
After four false starts, I asked myself: why am I fighting these tools? A portfolio doesn't need server-side rendering, complex data fetching, or most of what these frameworks provide. I briefly considered just writing plain HTML—but I wanted to stay sharp with React. So I built exactly what I needed and nothing more.
...
With the philosophy established, here's what I actually landed on. Each choice was deliberate—every dependency earned its place:
