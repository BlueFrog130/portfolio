import ogImage from 'virtual:og-image?title=Performance Optimization&description=React Compiler, code splitting, module preloading, and achieving fast Core Web Vitals.&tags=Performance,React,Vite&type=blog&seriesPart=8&seriesTotalParts=10';
...
_Next up: [Part 9 - SEO and Meta Tags](/blog/building-portfolio-part-9-seo) - Dynamic meta tags, Open Graph images, and search engine optimization_
