import ogImage from 'virtual:og-image?title=Building a Custom React Router&description=File-based route discovery, pattern matching, and ViewTransition API with React 19.&tags=React,Router,ViewTransitions&type=blog&seriesPart=2&seriesTotalParts=9';
