import ogImage from 'virtual:og-image?title=Lessons Learned&description=An honest retrospective on building a portfolio without a meta-framework.&tags=Retrospective,Learning,Architecture&type=blog&seriesPart=9&seriesTotalParts=10';
