import ogImage from 'virtual:og-image?title=Lessons Learned&description=An honest retrospective on building a portfolio without a meta-framework: what worked, what I would change, and when to roll your own vs. use a framework.&tags=Retrospective,Learning,Architecture&type=blog&seriesPart=9&seriesTotalParts=9';
...
Eight deep-dives later, here's the honest retrospective. What worked, what didn't, and whether I'd do it all over again.
