import ogImage from 'virtual:og-image?title=Hosting&description=Edge-first architecture with Hono, D1 database, and Vite integration.&tags=Cloudflare,Hono,Edge&type=blog&seriesPart=5&seriesTotalParts=10';
