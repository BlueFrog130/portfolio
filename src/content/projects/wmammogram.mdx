...
<Tree
	root="src"
	items={[
		{ name: 'assets/days', isFolder: true, description: 'Course content as TypeScript modules' },
		{ name: 'components', isFolder: true, description: 'Reusable Vue components (WVideo, Question, etc.)' },
		{ name: 'models', isFolder: true, description: 'TypeScript interfaces (User, Content, Day)' },
		{ name: 'services', isFolder: true, description: 'Business logic (ContentManager, DayManager)' },
		{ name: 'views', isFolder: true, description: 'Page-level components (Course, Dashboard)' },
		{ name: 'plugins', isFolder: true, description: 'Firebase & Vuetify initialization' },
		{ name: 'store', isFolder: true, description: 'Vuex state management' },
	]}
/>
