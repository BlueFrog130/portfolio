import ogImage from 'virtual:og-image?title=Duke Apartments&description=A modern, performant web application for Duke Street Apartments in Vermillion, South Dakota. This full-stack project showcases apartment listings with an elegant UI, advanced image optimization, and progressive web app capabilities.&tags=SvelteKit,TypeScript,SEO&type=project';
